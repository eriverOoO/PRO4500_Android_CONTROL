 ...
 * File: PRO4500.cpp
 *
 * Created by: JUNGSUNGIN
 * GitHub nickname: tom20250714
 *
 * This program provides a Windows GUI for controlling a TI LightCrafter
 * 4500-based light engine. It can adjust the Blue LED brightness through
 * USB HID commands and project image patterns on a selected display.
 *
 * Major features:
 * - Blue LED brightness control
 * - LED off command
 * - Folder-based image pattern projection
 * - Exposure time, dark time, repeat count, and display index settings
 * - Full-screen projection window with ESC/Stop termination
 */
